...
static struct ctl_table vm_table[] = {
   ...
   (defined(CONFIG_SUPERH) && defined(CONFIG_VSYSCALL))
	...
	},
	{
		...
		.data		= &failed_isolation_memory,
		.maxlen		= sizeof(failed_isolation_memory),
		.mode		= 0644,
	...
	},
	{
		...
		.mode		= 0644,
		.proc_handler   = count_reallocated_memory,
	},
	{
		.procname	= "free-non-buddy-memory",
		.data		= &free_non_buddy_memory,
		.maxlen		= sizeof(free_non_buddy_memory),
		.mode		= 0644,
